...
- **[KRX OpenAPI](https://openapi.krx.co.kr/)**: 2024~2025년 월말 종가·시가총액·상장주식수의 공식 출처 후보입니다. `KRX_AUTH_KEY`를 서버 Secrets에 보관합니다. 인증키 발급과 별개로 **유가증권 일별매매정보 및 코스닥 일별매매정보** 각각의 활용 승인 여부를 확인해야 합니다. 현재 앱에는 KRX 호출 코드가 없으므로 키만 설정해도 월말 자료는 자동 수집되지 않습니다.
